    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        if parameters['update_style_files_to_latest_version']:
            ...
            styles_list = ['Polygon_Style.qml', 'Exploded_Lines_Style.qml',
                           'Final_Vertices_Style.qml', 'Prill_lines_Style.qml', 'TopoPoint_Initial_Style.qml', 'TopoPoint_Setup_Style.qml',
                           'TopoLine_Initial_Style.qml', 'TopoLine_Setup_Style.qml', 'TopoPolygon_Initial_Style.qml', 'TopoPolygon_Setup_Style.qml']
